      ...
      <div className={'w-100 w-75-m  w-50-l mb5 relative head '} >
          ...
          <div className={'me w-80 w-60-m w-40-l  el-wrap x'}>
            ...
            <div className="tl credit ">
              ...
              <p className="f6 f5-l mv1">
              Photo by <a href="https://twitter.com/bensiordia" className="underline color">Benjamin Siordia</a>
              </p>
            </div>
            </div>
          </div>
          <div className="mt5">
            ...
            <h1 className=" f2 f1-l f-mt0 mv0  db"><a href="mailto:tommy@tmytrn.com" className=" underline red ">@tmytrn.com, I respond quick.</a></h1>
            <h1 className=" f2 f1-l f-mt0 mv5 db"><a href="/@tmytrn_CV_2020.pdf" className="underline color ph0" download>@tmytrn_CV_2020.pdf</a></h1>
          </div>
          </div>
          <style jsx >
              {`h1 {
