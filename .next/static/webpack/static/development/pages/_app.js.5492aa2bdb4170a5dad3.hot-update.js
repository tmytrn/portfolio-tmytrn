...
// Module
exports.push([module.i, ":root {\n  --width: 350px;\n  --x-speed: 13s;\n  --y-speed: 7s;\n  --transition-speed: 2.2s;\n}\n\n.el {\n  width: var(--width);\n  height: var(--width);\n  left: 0%;\n}\n\n.x {\n  animation: x var(--x-speed) linear infinite alternate;\n}\n\n.y {\n  animation: y var(--y-speed) linear infinite alternate;\n}\n\n@keyframes x {\n  100% {\n    transform: translateX(calc(100vw - var(--width)));\n  }\n}\n@keyframes y {\n  100% {\n    transform: translateY(calc(100vh - var(--width)));\n  }\n}", "",{"version":3,"sources":["/Users/tmytrn/portfolio-tmytrn/styles/bounce.scss"],"names":[],"mappings":"AAAA;EACI,cAAA;EACA,cAAA;EACA,aAAA;EACA,wBAAA;AACJ;;AAEE;EACE,mBAAA;EACA,oBAAA;EACA,QAAA;AACJ;;AAEE;EACE,qDAAA;AACJ;;AACE;EACE,qDAAA;AAEJ;;AACE;EACE;IACE,iDAAA;EAEJ;AACF;AAAE;EACE;IACE,iDAAA;EAEJ;AACF","file":"bounce.scss","sourcesContent":[":root {\n    --width: 350px;\n    --x-speed: 13s;\n    --y-speed: 7s;\n    --transition-speed: 2.2s;\n  }\n  \n  .el { \n    width: var(--width);\n    height: var(--width);\n    left: 0%;\n  }\n  \n  .x {\n    animation: x var(--x-speed) linear infinite alternate;\n  }\n  .y {\n    animation: y var(--y-speed) linear infinite alternate;\n  }\n  \n  @keyframes x {\n    100% {\n      transform: translateX(calc(100vw - var(--width)));\n    }\n  }\n  @keyframes y {\n    100% {\n      transform: translateY(calc(100vh - var(--width)));\n    }\n  }"]}]);


/***/ })

})
//# sourceMappingURL=_app.js.5492aa2bdb4170a5dad3.hot-update.js.map